                                ...
                                <div>
                                    <div class="form-group">
                                        ...
                                        <input name="answers[][answer]" type="text" 
                                            ...
                                            class="form-control" id="answer1" aria-describedby="choicesHelp" placeholder="Enter Option 1">
                                ...
                                <div>
                                    <div class="form-group">
                                        ...
                                        <input name="answers[][answer]" type="text" 
                                            ...
                                            class="form-control" id="answer2" aria-describedby="choicesHelp" placeholder="Enter Option 2">
                                ...
                                <div>
                                    <div class="form-group">
                                        ...
                                        <input name="answers[][answer]" type="text" 
                                            ...
                                            class="form-control" id="answer3" aria-describedby="choicesHelp" placeholder="Enter Option 3">
                                ...
                                <div>
                                    <div class="form-group">
                                        ...
                                        <input name="answers[][answer]" type="text" 
                                            ...
                                            class="form-control" id="answer4" aria-describedby="choicesHelp" placeholder="Enter Option 4">
